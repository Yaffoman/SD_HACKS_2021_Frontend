...
const city_types = ["Urban", "Rural", "Suburban"];

const food_types = ["beef", "lamb", "pork", "chicken", "other"];

const appliances_types = ["laundry", "dishwasher", "pool heater", "AC"];
    ...
    return (
      <>
        <Typography variant={"h2"} color={"primary"}>
          Update Your Daily Carbon Footprint
        </Typography>
      </>
    );
  }
      ...
      <>
        <Card variant={"outlined"} className="sourcebox">
          <CardContent>
            ...
            >
              <Grid item>
                <InputLabel htmlFor={`select${this.props.title}`}>
                  Select Type
                </InputLabel>
              ...
              <Grid item>
                <div>
                  <InputLabel htmlFor={`input${this.props.title}`}>
                    {getAmountText(this.props.title)}
                  </InputLabel>
    ...
    return (
      <>
        ...
        <Grid container spacing={4} direction={"column"} alignItems={"center"}>
          ...
          <Grid item xs={10} justify={"center"} xl={20}>
            <Button
              type={"submit"}
              variant={"contained"}
              color={"primary"}
