        ...
        <Grid container direction={"row"} alignItems={"center"}>
          <Grid item xs={4}>
            <BarChart
              width={375}
              height={350}
              people={["You", "USA Average", "World Average"]}
              values={[total_emissions, usa_emissions, world_emissions]}
            />
          </Grid>
          <Grid item xs={4}>
            <PieChart width={375} height={350} data={data} />
          </Grid>
          <Grid item xs={4}>
            <Typography
              variant={"h4"}
            ...
            >
              We recommend your initial goal to be: <b>{goal} kg/month</b> based
              on your current consumption and national averages
            </Typography>
          </Grid>
        </Grid>
      </>
...
export default function Results({ states }) {
  ...
  return (
    ...
    >
      <ChartsFragment
        emission={state.total}
        utilities={state.house}
        food={state.food}
        transportation={state.travel}
        misc={state.misc}
      />
      <Button
        variant={"contained"}
